  ...
  return (
    <div className="">
      ...
      <div className="text-right mx-5  my-2">
        ...
        <select className="my-1 shadow bg-white border rounded-lg  py-2 px-4 mr-4" id="status" onChange={handleSelectChange}>
      ...
      <div className="flex flex-wrap    justify-center items-center items-stretch ">
        {stories?.map((story) => (
          <div key={story.id} className="bg-white basis-10/12 sm:basis-1/3 lg:basis-1/4  dark:bg-gray-400 m-1 p-5">
            <div>
              ...
              <p className="py-1">Właściciel: {UserService.getUserName(story.userId)}</p>
            </div>
            <div className="text-center ">
              ...
              >
               <img src="/icons/editIcon.svg" alt="Delete"
					className="w-7 " />
              </button>
              <button
