	...
	return (
		<div className='background-form w-screen  h-screen fixed top-0 left-0'>
			<div className=' flex h-screen w-11/12 max-w-screen-md items-center mx-auto '>
				<div className='bg-gray-300 mx-auto rounded-xl w-full py-'>
					...
					<div className='text-center p-3 text-xl'>
						...
						<div className='m-5'>
							{task.status != Status.done && (
								<button
									className='mt-2 bg-gradient-to-r from-lime-700 to-green-600 text-white font-bold py-1 px-2 rounded'
							...
							{task.status == Status.doing && (
								<button
									className='ml-1 mt-2 bg-gradient-to-r from-lime-700 to-green-600 text-white font-bold py-1 px-2 rounded'
